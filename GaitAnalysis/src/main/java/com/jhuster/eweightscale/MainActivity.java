...
public class MainActivity extends TabActivity implements OnCheckedChangeListener {
    ...
    private static final String TAB_TAG_START   = "iStart";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec(TAB_TAG_DATAS)
                ...
                .setContent(iDatas));
        //对应活动未改
//        Intent iStart = new Intent(this, DataActivity.class);
//        mTabHost.addTab(mTabHost.newTabSpec(TAB_TAG_START)
//                .setIndicator(getResources().getString(R.string.menu_data), getResources().getDrawable(R.drawable.menu_data_selector))
//                .setContent(iStart));

        Intent iStart = new Intent(this, StartActivity.class);
        mTabHost.addTab(mTabHost.newTabSpec(TAB_TAG_START)
                .setIndicator(getResources().getString(R.string.menu_data), getResources().getDrawable(R.drawable.menu_start_selector))
                .setContent(iStart));
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        case R.id.MenuButtonDatas:
             ...
             break;
        case R.id.MenuButtonStart:
             this.mTabHost.setCurrentTabByTag(TAB_TAG_START);
             break;
